...
public final class ActivityLocationBinding implements ViewBinding {
  ...
  private ActivityLocationBinding(@NonNull RelativeLayout rootView, @NonNull Button confirm) {
  ...
  public static ActivityLocationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLocationBinding((RelativeLayout) rootView, confirm);
    }
